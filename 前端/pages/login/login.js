...
Page({
  ...
  async onGuestLogin() {
    ...
    this.showToast('以游客模式进入', 'success');
...
1. 服务条款
本软件为您提供法硕考试相关的学习资料和记忆卡片服务。

2. 账号安全
您需要妥善保管自己的账号信息，不得将账号借给他人使用。

3. 用户行为规范
您在使用本服务时应当遵守法律法规，不得发布违法违规内容。

4. 知识产权
本软件的所有内容受知识产权保护，未经授权不得复制或传播。

5. 免责声明
本软件提供的学习资料仅供参考，不构成法律建议。`
    });
  },
